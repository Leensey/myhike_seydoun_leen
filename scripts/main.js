    ...
    db.collection(collection)
        ...
        .then(allHikes => {
            ...
            allHikes.forEach(doc => { //iterate thru each doc
                ...
                newcard.querySelector('a').href = "eachHike.html?docID=" + docID; //piggybacking info after ? (pass info from one page to another)
                newcard.querySelector('i').id = 'save-' + docID;   //guaranteed to be unique
                newcard.querySelector('i').onclick = () => saveBookmark(docID);  // wouldnt work if u have multiple i tags
                ...
                document.getElementById(collection + "-go-here").appendChild(newcard); //bookmark icon thing must have been before this, done

                //i++;   //Optional: iterate variable to serve as unique ID
            })
        })
}
// commented out because called in doAll
